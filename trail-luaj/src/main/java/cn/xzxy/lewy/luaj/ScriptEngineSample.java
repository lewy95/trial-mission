...
public class ScriptEngineSample {
    public static void main(String[] args) {
        ...
        System.out.println("Engine name: " + f.getEngineName()); // Engine name: Luaj
        System.out.println("Engine Version: " + f.getEngineVersion()); // Engine Version: Luaj-jse 3.0.1
        System.out.println("LanguageName: " + f.getLanguageName()); // LanguageName: lua
        System.out.println("Language Version: " + f.getLanguageVersion()); // Language Version: 5.2
        String statement = f.getOutputStatement("\"hello, world\""); // print("hello, world")
        ...
        try {
            ...
            System.out.println("y=" + e.get("y")); // y=5

            e.put("x", 2);
            e.eval("y = math.sqrt(x)");
            System.out.println("y=" + e.get("y")); // y=1.4142135623730951

            e.put("f", new OneArgFunction() {
                public LuaValue call(LuaValue arg) {
                    System.out.println("arg " + arg.tojstring()); // arg abc
                    return LuaValue.valueOf(123);
                }
            });
            System.out.println("eval: " + e.eval("return f('abc')")); // eval: 123
            ...
            b1.put("x", 3);
            b2.put("x", 144);
            System.out.println("eval: " + cs.eval(b1)); // eval: 1.7320508075688772
            System.out.println("eval: " + cs.eval(b2)); // eval: 12
            System.out.println("y=" + b1.get("y")); // y=1.7320508075688772
            System.out.println("y=" + b2.get("y")); // y=12

            // In Luaj 3.0, client bindings can just be SimpleBindings.
            Bindings sb = new SimpleBindings();
            sb.put("x", 2);
            System.out.println("eval: " + cs.eval(sb)); // eval: 1.4142135623730951

            // Example of how exceptions are generated.
            try {
                e.eval("\n\nbuggy lua code\n\n");
            } catch (ScriptException se) {
                // script exception thrown for buggy script, message: 'eval threw javax.script.ScriptException: [string "script"]:3: syntax error'
